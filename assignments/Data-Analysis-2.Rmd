...
ggplot(data = q6.df, aes(x = volume.value)) +
  ...
  geom_vline(xintercept = q7.maxVal) +
...
# Adult output
print(paste("Adult harvest proportion:", (1 - prop.adults)[which.max(smooth.difference)])) # [1] 0.7416332
print(paste("Infant harvest proportion:", (1 - prop.infants)[which.max(smooth.difference)]))
