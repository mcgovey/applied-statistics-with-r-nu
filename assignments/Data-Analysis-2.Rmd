...
***Answer: Infants skewed right with some outliers***
...
grid.arrange(q3.shuckVolScatter, q3.logShuckVolScatter, ncol=2)
...
***Answer: At a much lower cutoff, specifically anything above 133.82, we would harvest more than 50% of the infant population. Whereas, the cutoff point where we would harvest more than 50% of the adult population doesn't occur until the cutoff point exceeds 384.51. ***
