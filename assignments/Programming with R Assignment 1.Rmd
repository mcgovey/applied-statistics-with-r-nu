...
```{r test1c}
q1FirstLastVec <- c(q1comboVec[0],q1comboVec[length(q1comboVec)])
q1FirstLastVec
...
```{r test2a}
# function will be posted in practice? sample function unclear where you will post
