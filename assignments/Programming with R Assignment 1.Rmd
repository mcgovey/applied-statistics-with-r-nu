...
plot(x, y, type="n", main = "Question 2c -2 to 2 sin(x/2) + cos(x/2)")
lines(x, q3y)
lines(x, q3y2)
par(new=TRUE)
plot(x[q3intersectPos], q3y[q3intersectPos], col="blue")

# need to add call out for max value
...
plot(x, q3y, type="n", main = "Question 3 -2 to 2 cos(x/2)*sin(x/2) vs. -(x/2)^3")
lines(x, q3y)
lines(x, q3y2)
par(new=TRUE)
plot(x[q3intersectPos], q3y[q3intersectPos], col="blue")
...
# apply() to return median values for three variables
medianTrees <- apply(trees, 2, median)
medianTrees

# row number and three measurements of any trees with girth equal to median


# make sure you know what girth is - diameter
```
