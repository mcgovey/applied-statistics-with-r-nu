...
kable(mydata[ratioOutliers_positions, ], format = "html", caption = "Mild Ratio Outliers Determined by Sex")
...
kable(mydata[ratioOutliersExtreme_positions, ], format = "html", caption = "Extreme Ratio Outliers Determined by Sex")
